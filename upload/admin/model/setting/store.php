...
class ModelSettingStore extends Model {
	public function addStore($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "store ( name ,  `url` ,  `ssl` ) values('" . $this->db->escape($data['config_name']) . "','" . $this->db->escape($data['config_url']) . "','" . $this->db->escape($data['config_ssl']) . "');");
