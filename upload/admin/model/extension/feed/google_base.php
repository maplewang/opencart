	...
	public function install() {
	 if ($this->config->get('db_type') == "CSQLite3") {
			$this->db->query("
				...
				'google_base_category_id'  INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
			...
			$this->db->query("
				...
				'google_base_category_id'  INTEGER(11) NOT NULL,
        ...
        foreach ($lines as $line) {
			if (substr($line, 0, 1) != '#') {
	            ...
	            if (isset($part[1])) {
	              ...
	              // $this->db->query("INSERT INTO " . DB_PREFIX . "google_base_category ( google_base_category_id ,  name )  values('" . (int)$part[0] . "','" . $this->db->escape($part[1]) . "');");
	              $this->db->query("INSERT INTO " . DB_PREFIX . "google_base_category_to_category ( google_base_category_id , category_id ) values('" . (int)$data['google_base_category_id'] . "', '" . (int)$data['category_id'] . "');");
	            }
			}
        }
    }
