...
class ModelCatalogAttributeGroup extends Model {
	public function addAttributeGroup($data) {
		...
		foreach ($data['attribute_group_description'] as $language_id => $value) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_group_description ( attribute_group_id , language_id ,name) values('" . (int)$attribute_group_id . "',  '" . (int)$language_id . "',  '" . $this->db->escape($value['name']) . "');");
		}
