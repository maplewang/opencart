...
class ModelCatalogRecurring extends Model {
	public function addRecurring($data) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "recurring` ( `sort_order` , `status` , `price` , `frequency` ,  `duration` , `cycle` , `trial_status` ,  `trial_price` , `trial_frequency` , `trial_duration` ,`trial_cycle`) values(" . (int)$data['sort_order'] . ", " . (int)$data['status'] . ", " . (float)$data['price'] . ", '" . $this->db->escape($data['frequency']) . "'," . (int)$data['duration'] . ", " . (int)$data['cycle'] . "," . (int)$data['trial_status'] . ", " . (float)$data['trial_price'] . ", '" . $this->db->escape($data['trial_frequency']) . "',  " . (int)$data['trial_duration'] . ",  '" . (int)$data['trial_cycle'] . "');");
