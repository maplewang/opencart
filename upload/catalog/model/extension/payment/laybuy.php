...
class ModelExtensionPaymentLaybuy extends Model {
	...
	public function updateCronRunTime() {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "setting` SET `store_id` = '0', `code` = 'laybuy', `key` = 'laybuy_cron_time', `value` = datetime('now'), `serialized` = '0'");
	}
